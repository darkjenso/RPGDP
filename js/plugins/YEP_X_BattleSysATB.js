...
//=============================================================================
 /*:
 * @plugindesc v1.00 (Requires YEP_BattleEngineCore.js) Add ATB (Active
...
BattleManager.startATB = function() {
    this.clearATBData();
    this._atbTarget = eval(Yanfly.Param.ATBFullGauge);
    this._atbCharge = eval(Yanfly.Param.ATBChargeGauge);
    this._atbFullTurn = eval(Yanfly.Param.ATBFullTurn);
    this._atbRubberband = eval(Yanfly.Param.ATBRubberband);
    if (this.atbRubberband()) {
      this._atbMinimumSpeed = eval(Yanfly.Param.ATBMinSpeed);
      this._atbMaximumSpeed = eval(Yanfly.Param.ATBMaxSpeed);
    }
    this._atbTicks = 0;
    this._atbReadySound = {
...
BattleManager.processEscape = function() {
    var success = Yanfly.ATB.BattleManager_processEscape.call(this);
    if (!success && this.isATB()) {
